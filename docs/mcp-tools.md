...
## Deprecated mapping (current -> target)
- listChannels -> channelsList
- searchChannels -> channelsSearch
- listActiveChannels -> channelsList (includeInactive=false)
- getChannelMessages -> messagesList (source=live)
- getTopicMessages -> messagesList (source=live, topicId)
- getArchivedTopicMessages -> messagesList (source=archive, topicId)
- searchSyncedMessages -> messagesSearch (source=archive)
- searchTaggedMessages -> messagesSearch (tags=[...])
- scanTaggedMessages -> messagesSearch + channelsTagsAuto (client side orchestration)
- setChannelTags -> channelsTagsSet
- listChannelTags -> channelsTagsList
- listTaggedChannels -> channelsTagsSearch
- refreshChannelMetadata -> channelsMetadataRefresh
- getChannelMetadata -> channelsMetadataGet
- scheduleMessageSync -> syncJobsAdd
- listMessageSyncJobs -> syncJobsList
